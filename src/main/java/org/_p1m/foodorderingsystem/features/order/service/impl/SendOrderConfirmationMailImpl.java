...
public class SendOrderConfirmationMailImpl implements SendOrderConfirmationMail {
    ...
    private void processOrderData(Long orderId) throws MessagingException, IOException {
        ...
        String username = cartItems.isEmpty() ? "Customer" : cartItems.get(0).getCustomer().getProfile().getName();
        ...
        String userEmail = cartItems.isEmpty() ? "" : cartItems.get(0).getCustomer().getEmail();
//        Integer quantity = cart.getQuantity();
        ...
        for (AddCartData cart : cartItems) {
            Integer quantity = cart.getQuantity();
            ...
            BigDecimal itemTotal = menuPrice.add(extraPrice);
